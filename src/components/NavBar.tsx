...
export default function NavBar() {
    ...
    return (
        <nav className={`flex px-3 text-sm font-medium rounded-full justify-center items-center transition-all duration-300 
            ...
            <a href="#exp" className="relative block px-2 py-2 text-gray-200 hover:text-[#A6FF00]">Experience</a>
            <a href="#projects" className="relative block px-2 py-2 text-gray-200 hover:text-[#A6FF00]">Projects</a>
            <a href="#about" className="relative block px-2 py-2 text-gray-200 hover:text-[#A6FF00]">About</a>
            <a href="#contact" className="relative block px-2 py-2 text-gray-200 hover:text-[#A6FF00]">Contact</a>
